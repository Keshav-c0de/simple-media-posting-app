...
from app.schema import PostCreate, UserUpdate, UserCreate, UserRead
from app.db import  get_async_session, create_db_and_tables, Post, User
from app.image import image_kit
...
async def delete_post(post_id: str, session: AsyncSession = Depends(get_async_session),user: User = Depends(current_active_user)):
    try:
        ...
        return {"success":True, "message": "post had been deleted"}
